...
class EdgeList:
    ...
    def to(self, device: torch.device, *, non_blocking: bool = False, copy: bool = False) -> "EdgeList":
        return type(self)(
            self.lhs.to(device, non_blocking=non_blocking, copy=copy),
            self.rhs.to(device, non_blocking=non_blocking, copy=copy),
            self.rel.to(device, non_blocking=non_blocking, copy=copy),
        )